...
async function main() {
  console.log('════════════════════════════════════════════════════════════════════════════');
  console.log('AUDITED MIGRATION: CALIBRATE TYRANNOSAURUS REX (ID 24) HORIZONTAL SILHOUETTE');
  console.log('════════════════════════════════════════════════════════════════════════════\n');
  ...
  const preSnapshotPath = path.join(snapshotDir, `pre_fix_trex_${timestamp}.json`);
  ...
  // STEP 2: Download calibrated horizontal lateral silhouette from PhyloPic
  console.log('Step 2: Downloading Conty / T. Michael Keesey calibrated horizontal silhouette from PhyloPic...');
  ...
  // Morphological validation: verify aspect ratio >= 2.5 (horizontal full body lateral profile)
  ...
  // STEP 3: Update Tyrannosaurus rex record in database
  ...
  const postSnapshotPath = path.join(snapshotDir, `post_fix_trex_${timestamp}.json`);
  ...
  console.log('\n════════════════════════════════════════════════════════════════════════════');
  console.log('✅ TYRANNOSAURUS REX SILHOUETTE MIGRATION COMPLETED SUCCESSFULLY!');
  console.log('════════════════════════════════════════════════════════════════════════════\n');
}
